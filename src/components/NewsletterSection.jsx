  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 py-16 lg:py-24">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-light text-center mb-4">
          ABONNIEREN SIE UNSEREN NEWSLETTER
        </h1>
        <p className="text-center text-xs sm:text-sm md:text-base mb-6 font-extralight w-full max-w-md">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center w-full max-w-md">
          ...
          />
          <button className="w-full sm:w-auto p-2 bg-[#AF382D] text-white rounded sm:rounded-r-lg">
            Abonnieren
          </button>
        </div>
        ...
        <div className="relative z-10 w-full max-w-6xl mt-16 lg:mt-20 flex flex-col sm:flex-row items-center justify-between py-4 px-4 md:px-8 lg:px-24">
          ...
          <div className="flex-shrink-0 mb-4 sm:mb-0">
            <Image
              src="/logogas-removebg-preview.png" // Replace with your logo path
              alt="Logo"
        ...
        <div className="relative z-10 w-full max-w-6xl flex flex-col md:flex-row justify-between gap-8 md:gap-10 px-4 md:px-8 lg:px-24 mt-8 text-white">
          ...
          <div className="md:w-1/4 flex flex-col items-start text-left">
            <p className="text-xs sm:text-sm leading-relaxed">
              Gasthof Hecht mit einer Tradition des Genusses und der Entspannung.
              Bekannt für seine raffinierte Küche, erlesene Weine und gemütliche
              Zimmer. Wir freuen uns auf Sie!
            </p>
            <address className="mt-4">
              <h3 className="capitalize text-lg sm:text-xl md:text-2xl">
                Gasthof Hecht
              </h3>
              <p className="text-xs sm:text-sm">Zürichstrasse 12 CH-8185 Winkel</p>
            </address>
          </div>

          {/* Column 2: Links */}
          <div className="md:w-1/4 flex flex-col items-start text-left">
            <h2 className="text-lg sm:text-xl md:text-2xl font-light mb-4 sm:mb-6">
              LINKS
            </h2>
